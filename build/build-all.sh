...
if [ "$1" == "" ]; then
  ...
  docker build -t=registry.cn-shenzhen.aliyuncs.com/acs1/csi-rds-raw-block-metric:$VERSION-$GIT_HASH ./
  ...
  docker push registry.cn-shenzhen.aliyuncs.com/acs1/csi-rds-raw-block-metric:$VERSION-$GIT_HASH
fi
